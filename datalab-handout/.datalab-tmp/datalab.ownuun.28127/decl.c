...
{"isAsciiAlpha",
 (funct_t)isAsciiAlpha,
 (funct_t)test_isAsciiAlpha,
 1,
 "! ~ & ^ | + << >>",
 20,
 3,
 ...
 {"floatScale4", (funct_t) floatScale4, (funct_t) test_floatScale4, 1,
    "$", 30, 4,
     {{1, 1},{1,1},{1,1}}},
 {"trueSevenSixteenths", (funct_t) trueSevenSixteenths, (funct_t) test_trueSevenSixteenths, 1,
    "! ~ & ^ | + << >>", 25, 4,
  {{TMin,TMax},{TMin,TMax},{TMin,TMax}}},
  {"", NULL, NULL, 0, "", 0, 0,
   {{0, 0},{0,0},{0,0}}}
